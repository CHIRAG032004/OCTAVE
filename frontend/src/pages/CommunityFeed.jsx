                                            ...
                                            <div className="flex items-start justify-between mb-3">
                                                <div className="flex items-center gap-2">
                                                    <span className={`px-2 py-1 text-xs capitalize font-medium rounded-full ${
                                                        normalizeIssueStatus(issue.status) === 'open' ? 'bg-red-100 text-red-700' :
                                                        normalizeIssueStatus(issue.status) === 'in progress' ? 'bg-blue-100 text-blue-700' :
                                                        normalizeIssueStatus(issue.status) === 'pending' ? 'bg-yellow-100 text-yellow-700' :
                                                        normalizeIssueStatus(issue.status) === 'resolved' ? 'bg-green-100 text-green-700' :
